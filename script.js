$(document).ready(function(){
	...
	$('#recipeBook').click(function(){
	   ...
	   $('#modalText').text('AngularJS based Recipe Book social network served on a Node.JS/Express server. The application that will allow users to create recipes and store them as well as share recipes. Members will be able to see new recipes from old friends and "company pages" that provide recipes. ');
	});
});
